...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Seba\Projects\Python\PyCharm\pythonProject\pythonProject1\ListComprehension'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Seba\Projects\Python\PyCharm\pythonProject\pythonProject1\ListComprehension\Scripts\deactivate.nu'
