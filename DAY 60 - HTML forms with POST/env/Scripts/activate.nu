...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Seba\Projects\Python\PyCharm\DAY 60 - HTML forms with POST\env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Seba\Projects\Python\PyCharm\DAY 60 - HTML forms with POST\env\Scripts\deactivate.nu'
