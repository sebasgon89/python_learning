...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Seba\Projects\Python\PyCharm\spotify_playlist'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Seba\Projects\Python\PyCharm\spotify_playlist\Scripts\deactivate.nu'
