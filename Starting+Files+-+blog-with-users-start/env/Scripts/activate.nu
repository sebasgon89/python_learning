...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Seba\Projects\Python\PyCharm\Starting+Files+-+blog-with-users-start\env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Seba\Projects\Python\PyCharm\Starting+Files+-+blog-with-users-start\env\Scripts\deactivate.nu'
