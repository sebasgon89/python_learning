...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Seba\Projects\Python\PyCharm\Day61\Day 63 - Library'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Seba\Projects\Python\PyCharm\Day61\Day 63 - Library\Scripts\deactivate.nu'
